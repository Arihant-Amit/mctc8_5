...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, IR_TEMP_Pin|HS_R_Pin|HS_L_Pin);

    HAL_GPIO_DeInit(AMBIENT_ADC_GPIO_Port, AMBIENT_ADC_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PB3     ------> SPI3_SCK
    */
    HAL_GPIO_DeInit(GPIOB, LORA_MOSI_Pin|LORA_SCK_Pin);

    HAL_GPIO_DeInit(LORA_MISO_GPIO_Port, LORA_MISO_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, CURRENT_SCK_Pin|CURRENT_MISO_Pin|CURRENT_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(GPIOC, SLAVE_DE_Pin|SLAVE_TX_Pin);

    HAL_GPIO_DeInit(SLAVE_RX_GPIO_Port, SLAVE_RX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, SDA_RX_Pin|SDA_TX_Pin);

    HAL_GPIO_DeInit(SDA_DE_GPIO_Port, SDA_DE_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(MODEM_DE_GPIO_Port, MODEM_DE_Pin);
